  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-600 px-6 py-8 sm:px-8 sm:py-10">
          <div className="text-center">
            ...
            <p className="text-purple-100">Join LapMart and start shopping</p>
          </div>
        </div>
        ...
        <div className="px-6 py-8 sm:px-8 sm:py-10">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <button
                type="button"
                className="flex items-center justify-center gap-2 px-3 py-3 border-2 border-gray-200 rounded-lg hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 hover:shadow-md group"
              >
              ...
              >
                ...
                <span className="text-sm font-semibold text-gray-700 hidden sm:inline">Facebook</span>
              </button>
            </div>
          </form>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/login" className="font-bold text-purple-600 hover:text-purple-700 hover:underline transition-all">
                Sign in
              </Link>
            </p>
          </div>
